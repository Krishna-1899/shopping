...
function Product({ post }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-5  border-[1px] border-solid border-[#a0a0a0] rounded-xl hover:shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px]">
      <div>
